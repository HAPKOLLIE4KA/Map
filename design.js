...
itemSwitchStyle.addEventListener("click", 
    () => {
        ...
        menuWeb.style.backgroundColor = themeStyle.menuBackgroundColor
        menuWeb.style.boxShadow = switchStyle ? "0px 5px 20px black" : "0px 5px 20px silver";
